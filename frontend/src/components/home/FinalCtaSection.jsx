export default function FinalCtaSection() {
  return (
    <section
      id="quote"
      className="scroll-mt-24 bg-linear-to-br from-red-700 via-red-800 to-slate-900 py-20 sm:py-24"
    >
      <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
        ...
        <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row sm:gap-5">
          <a
            href="#contact"
            className="inline-flex w-full min-w-[200px] items-center justify-center rounded-xl bg-white px-8 py-3.5 text-base font-semibold text-red-900 shadow-lg transition hover:-translate-y-0.5 hover:bg-red-50 sm:w-auto"
          >
            Get Your Project
          </a>
          <a
